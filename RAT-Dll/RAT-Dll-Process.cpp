			...
			if (hProcess != NULL)
			{
				...
				if (EnumProcessModules(hProcess, &hMod, sizeof(hMod), &cbNeeded))
				{
					...
					**processNames = (CHAR*)malloc(sizeof(char) * sizeof(szProcessName) / sizeof(CHAR));
					...
					if (!memcpy(**processNames, szProcessName, sizeof(szProcessName)))
					{
